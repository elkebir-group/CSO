...
private:
  ...
  bool addGamete(int nLoci,
                 const DoubleMatrix& RM,
                 const Genotype& ideotype,
                 double probLowerBound,
                 int minimalSubGroupSize,
                 const std::vector<int>& homozygousLoci,
                 const std::vector<int>& heterozygousLoci,
                 int c);

  void computeGametes(int nLoci,
                      const DoubleMatrix& RM,
                      const Genotype& ideotype,
                      double probLowerBound,
                      int minimalSubGroupSize,
                      ...
                      const std::vector<int>& fixedCrossOverPoints,
                      int& addedGametesCount);

  int computeGametesOneCrossOver(int nLoci,
                                 const DoubleMatrix& RM,
                                 const Genotype& ideotype,
                                 double probLowerBound,
                                 int minimalSubGroupSize,
  ...
  int computeGametesTwoCrossOvers(int nLoci,
                                  const DoubleMatrix& RM,
                                  const Genotype& ideotype,
                                  double probLowerBound,
                                  int minimalSubGroupSize,
...
public:
  ...
  void computeGametes(int nLoci,
                      ...
                      const Genotype& ideotype,
                      double probLowerBound,
                      bool restrictGametes,
                      int maxCrossOver);
  void computeGametesCumulative();
  const GameteVector& getGametes() const;
  Gamete getGameteMostAlike(int nLoci,
                            int target) const;
  Gamete getGameteMostAlikeProportionate(int nLoci,
                                         int target) const;
...
inline bool GenotypeGamete::addGamete(int nLoci,
                                      const DoubleMatrix& RM,
                                      const Genotype& ideotype,
                                      double probLowerBound,
                                      int minimalSubGroupSize,
